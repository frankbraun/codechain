...
func TestKey(t *testing.T) {
	...
	err = KeyFile("codechain", homedir.Codechain(), "pubkey", "-s", "testkey.bin")
	if err != nil {
...
func TestHelp(t *testing.T) {
	...
	// codechain keygen -h
	err = KeyGen("codechain", homedir.Codechain(), "codechain keygen", "-h")
	if err != flag.ErrHelp {
		t.Errorf("codechain keygen -h should fail with flag.ErrHelp: %v", err)
	}
	// codechain keyfile -h
	err = KeyFile("codechain", homedir.Codechain(), "codechain keyfile", "-h")
	if err != flag.ErrHelp {
